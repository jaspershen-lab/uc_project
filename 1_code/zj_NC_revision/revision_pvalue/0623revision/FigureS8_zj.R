...
t.test(data$value[data$group == "Control"],
       data$value[data$group == "UC in remission"])

# Control vs Active UC
t.test(data$value[data$group == "Control"],
       data$value[data$group == "Active UC"])

# UC in remission vs Active UC
t.test(data$value[data$group == "UC in remission"],
       data$value[data$group == "Active UC"])
